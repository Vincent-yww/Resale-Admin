<template>
  <div class="layout">
    ...
    <div class="topbar-wrapper" :style="{left: this.isCollapsed?'64px':'200px'}">
      ...
      <div class="title float-left">Resale-后台管理系统</div>
        ...
        <li v-if="user" class="menu-item" style="padding: 0;">
          <el-dropdown
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="b">菜单项3</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </li>
        <li class="menu-item">
      ...
      return {
        sider_menu_data: [
          ...
          },
          {
            ...
            children: [
              {path: '/users/basic', title: '普通用户'},
              {path: '/users/admin', title: '管理员用户'},
            ]
          },
          {
            path: '/category/index',
